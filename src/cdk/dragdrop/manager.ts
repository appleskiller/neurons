...
import { removeClass, addEventListener, addClass, removeMe, insertBefore, insertAfter, isInDocument } from 'neurons-dom';
import { isBrowser, isEmpty, geometry, isDefined } from 'neurons-utils';
import { tween } from 'neurons-animation';
...
export class DragManager extends EventEmitter implements IDragManager {
    ...
    startDrag(dom: HTMLElement, startEvent: MouseEvent, scope?: string, data?: any) {
        ...
        const dragSource: IDragSource = {
            ...
            data: typeof dragOption.data === 'function' ? dragOption.data(dom) : dragOption.data,
            element: dom,
    ...
    private _pointIntersectRect(dragOption: IDraggableOption, mousePoint, detectRect) {
        ...
        return geometry.pointIntersectRect(mousePoint, detectRect);
    }
