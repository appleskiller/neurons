...
import { StateChanges, IElementRef, IChangeDetector } from '../../compiler/common/interfaces';
...
export class CollapsibleList<T> {
    ...
    moreDataProvider: T[] = [];
    itemRefs: IElementRef<any>[] = [];
    moreRef: IElementRef<any>;
    ...
    protected createItemRenderer(item: T, index: number): IElementRef<any> {
