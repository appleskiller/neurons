...
@UIBinding({
    ...
    template: `
        <div [class]="{'ne-search-input': true, 'focused': focus, 'collapsible': collapsible, 'expanded': expanded}" (click)="onHostClick($event)">
            <ne-icon
    ...
    style: `
        ...
        .ne-search-input.focused {
            border-bottom: solid 1px rgba(26, 115, 232, 1);
        }
